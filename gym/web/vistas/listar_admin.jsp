    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= per.getDoc()%></td>
                        <td class="text-center"><%= per.getTipo_doc()%></td>
                        <td class="text-center"><%= per.getNomb_1()%> <%=per.getNomb_2()%></td>
                        <td class="text-center"><%= per.getApel_1()%> <%= per.getApel_2()%></td>
