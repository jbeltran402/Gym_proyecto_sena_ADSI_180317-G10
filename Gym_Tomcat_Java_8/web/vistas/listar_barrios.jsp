...
<div style="padding: 2% 5% 5%;">
    <center><h1> Barrios </h1></center>

        <div class="form-row">
            <div class="form-group col-md-9">
                <a class="btn btn-success " href="Controlador?accion=add_barrio">Agregar Nuevo</a>
            </div>
        </div>
    ...
    <table>
        ...
        <tbody>
        <tr>
            <td><%= barrio.getBarrio()%></td>
            <td><%= barrio.getLocalidad()%></td>

            <td>
                <a class="btn btn-warning" href="Controlador?accion=editar_barrio&barrio=<%= barrio.getBarrio()%>&id=<%= barrio.getCod_barrio()%>">Editar</a>

                <a class="btn btn-danger" href="Controlador?accion=eliminar_barrio&id=<%= barrio.getCod_barrio()%>">Eliminar</a>
            </td>
