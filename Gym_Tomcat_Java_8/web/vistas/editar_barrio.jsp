...
<div class="container" style="padding-bottom: 2%">
    <div class="col-lg-6">
        ...
        <form method="post" action="Controlador">
            ...
            Nombre de barrio<br>
            <input class="form-control" type="text" name="barrio" value="<%=request.getAttribute("Barrio")%>" required><br>
            ...
            <br>
            <input class="btn btn-success" type="submit" name="accion" value="Editar barrio">
